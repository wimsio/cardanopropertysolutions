                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/logo.jpeg" style="border-radius:4px;width:135px;height:56px;" alt="image"></a> </div>
                                        <p class="pb-20 text-white">Cardano Property Solutions is a platform for prototyping tokenization and fractionalization using Cardano blockchain. This lowers investment costs, speeds up property sales and distribute wealthy equitably.
                                        </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Cardano Property Solutions</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>Bernard Sibanda</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+27 73 182 0631</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>admin@cardanopropertysolutions.co</li>
                                                </ul>
