...
<label class="col-lg-2 col-form-label">Feature</label>
  <p class="alert alert-danger">Additional Information</p>
  <textarea class="tinymce form-control" name="additionalInformation" id="additionalInformation" rows="2" cols="30"></textarea>
<div class="col-lg-9">
    <table>
        <tr><th>Item</th><th>Options</th></th>
        <tr><td>Property Age :</td><td><input type="number" name="propertyAge" step="1" min="1" max="25"></td></tr>
        <tr><td>Dining Capacity :</td><td><input type="number" name="dinningCapacity" step="1" min="1" max="25"></td></tr>
        <tr><td>Swiming Pool?</td>
            <td>        
            <select name="swimmingpool" id="Swimming Pool">
              <option value="-">-</option>
        ...
        <tr><td>Security?</td>
         ...
         <tr><td>Church/Temple?</td>
            <td>        
            <select name="churchOrTemple" id="churchOrTemple">
              <option value="-">-</option>
              <option value="yes">Yes</option>
              <option value="no">No</option>
            </select>
