export const shareTokensTrade =
`
spending shareTokensTrade
/*
...
func main(datum: Datum, redeemer: Redeemer, ctx: ScriptContext) -> Bool {
    ...
    jlogValHash("validator_hash",validator_hash);
    ...
    redeemer.switch 
    {
        ...
        b:Buy=>{
            ...
            sellerAmountLovelace:Int = datum.nftUnitPriceLovelace * b.nftQuantity;
            
            jlogBool("sellerValue",tx.value_sent_to(datum.seller).get_lovelace() >= sellerAmountLovelace);
            
            
            (tx.value_sent_to(datum.seller).get_lovelace() >= sellerAmountLovelace) &&
